    ...
    const validate = (d) => {
        ...
        return true;
          ...
          const handlePicturesChange = (event) => {
              const a = { ...data, pictures: event.target.value };
              setData(a);
          };
          ...
          <Grid container spacing={6}>
            ...
            <Grid container xs={12} display="flex" pt={2} spacing={2}>
                <Grid item xs={6} sm={3}>
                    <MDInput
                        label={t("pictures")}
                        value={data && data.pictures ? data.pictures : ""}
                        onChange={handlePicturesChange}
                        helperText={error && error.pictures ? error.pictures : ""}
                    />
                </Grid>
            </Grid>
